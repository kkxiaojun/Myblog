...
<body>
    <header>
        ...
        <nav id="nav_menu">
            <ul>
                ...
                <li><a href="/doArticle" id="article">Aticle</a></li>
                <li><a href="/doDemo">Demo</a> </li>
                <li><a href="/doUser/blog/contact">Contact</a> </li>
            </ul>
        </nav>
    ...
    <section class="main">
        <div class="hero_img">
            <img src="<c:url value="/style/img/hero2.jpg"/>" title="" />
        </div>
        <!-- End hero_img-->
        <div class="main_content">
            <h1>欢迎来到我的个人网站</h1>
            <hr>
            <p>目的：此次设计的个人网页，一方面是为了完成我们的作业，但更重要的是把我们所学到的东西用在具体的实践之中，所以，这次设计的目的也是要我们更好的掌握和使用好核心工具和技术，以便提高对网页知识的更深层了解。 </p>
            <p>技术介绍：使用了Sublime编辑器，利用更重css3、html5制作了极简的风格</p>
            <p>特点：不仅实现了pc端，还添加了响应式布局，在移动端也可以无障碍浏览</p>
        </div>
        <!-- End main_content-->
    </section>
    <!-- End main  -->
